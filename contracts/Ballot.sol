...
contract Ballot is Ownable, Voting {
    ...
    function registerCandidate(uint issueId, bytes16 newName, bytes32 newDescription) public onlyOwner returns (uint){
        return addCandidate(issueId, newName, newDescription);
    }
